...
impl<N, E> Graph<N, E> {
  ...
  pub fn get_edges<'a>(&self, path: impl Into<&'a [usize]>) -> impl Iterator<Item = Option<&'_ E>> {
    path
      .into()
      .windows(2)
  ...
  pub fn add_edge_map(&mut self, from: usize, to: usize, edge_value: fn(&N, &N) -> E) -> Option<E> {
